...
TRUNCATE TABLE `listings_upload`;
-- --------------------------------------------------------
...
TRUNCATE TABLE `locations_areas`;
--
...
TRUNCATE TABLE `locations_towns`;
--
...
TRUNCATE TABLE `permissions_users`;
--
...
TRUNCATE TABLE `property_list_es`;
--
...
TRUNCATE TABLE `property_list_types`;
--
...
TRUNCATE TABLE `property_open_houses`;
-- --------------------------------------------------------
...
TRUNCATE TABLE `property_pricing_types`;
--
...
TRUNCATE TABLE `property_types_sub`;
--
