    ...
    <div class="card shadow-3" id="info">
        ...
        <div class="card-body">
               ...
               <div class="col-3">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <p class="text-muted" style="line-height: 1.2; margin-top: 8px"> Add new types in the <br><a href="/adm/property-types.php">Property Types Page <span class="ti-new-window"></span></a>.</p>
                    </div>
                </div>
                <div class="col-3">
                  <div id="sub_types_select">
                      <?php if($edit_list == 1 && !empty($properties->PropertyTypes[$prop->PropertyTypeId]['subs'])){ ?>
                       <div class="form-group">
                         ...
                         <p class="text-muted" style="line-height: 1.2; margin-top: 8px"> Add morenew subtypes in the <br><a href="/adm/property-sub-types.php">Property Sub Types Page <span class="ti-new-window"></span></a>.</p>
                       </div>
                    <?php } ?>
                  </div>
                </div>
            ...
            <div class="row">
                <div class="col-5">
                    <div class="form-group">
                        <label style="display: inline-block; margin-right: 13px;">Property in foreclosure?</label>
                ...
                <div class="col-6">
                    <div class="form-group">
                        <label style="display: inline-block; margin-right: 13px;">Property under construction?</label>
                        <div class="form-check form-check-inline">
                ...
                <div class="col-3">
                   <div class="form-group">
                       ...
                       <small class="form-text">
                           <i class="ti-star text-info"></i> 
                           Add new area by typing input.
                       </small>
                   </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <p class="form-text">
                           ...
                           <a href="https://www.latlong.net/convert-address-to-lat-long.html" target="_blank">Lookup coordinates here</a> to add to website search map
                           </p>
                    </div>
                </div>
               </div>
                      ...
                      <div class="dz-preview dz-file-preview">
                        <div class="dz-details">
                          <div class="dz-img-contain">
                            <img src="<?= $uploads_folder.$val[0].'/thumbs/'.$val[1] ?>" data-dz-thumbnail />
                          </div>
