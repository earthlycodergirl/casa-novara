                    ...
                    <div class="card shadow-3 mb-4">
                        ...
                        <div class="card-body">
                          ...
                          <?php if($type_form == 'office'){ ?>
                            ...
                            <?php if(!empty($con->ContactInfo[$key]) && $key != 'office_info'){ 
                            ...
                            <?php } } elseif(!empty($con->ContactInfo[$key]) && $key == 'office_info') { 
                              // For office_info, entries are already displayed in their respective sections above
                              // This section handles the display when JavaScript loads existing items
                              foreach($con->ContactInfo[$key] as $kk=>$ll){
