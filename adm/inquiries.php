            ...
            <div class="card-body">
                <table class="table table-striped" data-provide="datatables">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?= $li->request_id ?></td>
                            <td><?= date('d/M/y',strtotime($li->request_timestamp)) ?><br /><small><?= date('g:i a',strtotime($li->request_timestamp)) ?></small></td>

                            <td><?= $li->client_name ?>
                              <br /><a href="mailto:<?= $li->client_email ?>"><?= $li->client_email ?></a>
                              <br /><?= $li->client_phone ?></td>
                            <td><a href="<?= $listing_url.$li->property_id ?>" target="_blank"><?= $li->property_title ?></a></td>
                            <td><small><?= $li->client_notes ?></small></td>
                            <td class="text-right table-actions">
                                <a class="table-action hover-danger delete-entry" data-provide="tooltip" title="Delete request" href="#" data-id="<?= $li->request_id ?>"><i class="ti-trash"></i></a>
                              </td>
                        </tr>
                        <?php } } ?>
                    </tbody>
    ...
    <div class="modal modal-top fade" id="delete_entry" tabindex="-1" aria-hidden="true" style="display: none;">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form action="inquiries.php" method="get">
              <input type="hidden" name="dd" value="0" id="dd">
          <div class="modal-body">
              <p><b>Are you sure you would like to permanently delete this request?</b> You will not be able to recover the client information once this is done. Please confirm your decision.</p>
