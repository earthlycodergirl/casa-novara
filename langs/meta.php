...
if($lang == 'en'){
  ...
  $meta['list']['title'] = 'Sell your property - Mexico Real Estate';

  // MAP LIST
  $meta['map']['title'] = 'Properties for sale in ';
  $meta['map']['desc'] = 'See a map of all the properties available in [CITY], Mexico. Best price guarantee for [CITY] real estate. Properties, lots and land for sale in [CITY], Mexico';

  // PROPERTIES LIST
  $meta['props']['title'] = 'Real Estate in ';
...
if($lang == 'es'){
  ...
  $meta['list']['title'] = 'Venda su propiedad - México Inmobiliaria';

  // MAP LIST
  $meta['map']['title'] = 'Propiedades a la venta en ';
  $meta['map']['desc'] = 'Vea un mapa de todas las propiedades disponibles en [CITY], México. Mejor precio garantizado para la propiedad inmobiliaria de [CITY]. Propiedades, lotes y terrenos en venta en [CITY], México';

  // PROPERTIES LIST
  $meta['props']['title'] = 'Bienes Raices en ';
  $meta['props']['desc'] = 'Vea una lista de todas las casas y terrenos disponibles en [CITY], México. Mejor precio garantizado para la propiedad inmobiliaria de [CITY]. Propiedades, lotes y terrenos en venta en [CITY], México';

  // BLOG LIST
  $meta['blog']['title'] = 'Información sobre Bienes Raices en Cancun';
  $meta['blog']['desc'] = 'Lugar perfecto para encontrar todo lo que necesita saber sobre la compra de bienes raíces en la Riviera Maya, México. Playa del Carmen Real Estate 101. Asesoramiento inmobiliario local.';
}
?>