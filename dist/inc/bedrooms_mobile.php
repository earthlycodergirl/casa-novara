...
if($prop->Bedrooms >= 1){ ?>
 <!-- detail bedrooms -->
 <div class="prop-det d-inline-flex">
    <div class="icon">
       <svg xmlns="http://www.w3.org/2000/svg" width="20.4" height="13.6" viewBox="0 0 20.4 13.6">
         <path id="Icon_ionic-md-bed" data-name="Icon ionic-md-bed" d="M10.062,16.252a2.721,2.721,0,1,0-2.784-2.72A2.75,2.75,0,0,0,10.062,16.252Zm11.13-5.44H13.77V17.16H6.354V9H4.5V22.6H6.354V19.88H23.046V22.6H24.9V14.44A3.668,3.668,0,0,0,21.192,10.812Z" transform="translate(-4.5 -9)" fill="#ccc"/>
       </svg>
    </div>
    <div class="val flex-fill "><?= $prop->Bedrooms ?> <?php echo $prop->Bedrooms == 1 ? $lan['prop']['beds'][5] : $lan['prop']['beds'][4]; ?></div>
 </div>
 <!-- detail bedrooms end -->
...
<?php } if($prop->Size->Ft > 0){ ?>
 ...
 <div class="prop-det d-inline-flex">
    ...
    <div class="val flex-fill sizes"><?= number_format((int)$prop->Size->Mt).' mt&sup2;'; ?></div>
 </div>
