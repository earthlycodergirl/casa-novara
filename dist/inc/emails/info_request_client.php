...
if(isset($_POST['prop']) && $_POST['prop'] > 0 && isset($_POST['em'])){
	$prop = new Emails();
	...
	$email = $prop->test_input($_POST["em"]);
...
<head>
	...
	<!--<![endif]-->
	<title>Property Information Request Received</title>
	<!--[if gte mso 9]>
																	...
																	<table width="100%" border="0" cellspacing="0" cellpadding="0">
																		<tr>
																			<td class="px-50 mpx-15" style="padding-left: 50px; padding-right: 50px;">
																					...
																					<tr>
																						<td align="center">
																							...
																							<table border="0" cellspacing="0" cellpadding="0" style="min-width: 200px;">
																								<tr>
																									<td class="btn-16 c-white l-white" bgcolor="#92C01F" style="font-size:16px; line-height:20px; mso-padding-alt:15px 35px; font-family:\'PT Sans\', Arial, sans-serif; text-align:center; font-weight:bold; text-transform:uppercase; border-radius:25px; min-width:auto !important; color:#ffffff;">
																										<a href="https://casanovaragroup.com/listing/'.$prop->Property->property_id.'" target="_blank" class="link c-white" style="display: block; padding: 15px 35px; text-decoration:none; color:#ffffff;">
																											<span class="link c-white" style="text-decoration:none; color:#ffffff;">VIEW PROPERTY</span>
																										</a>
																									</td>
																								</tr>
																							</table>
																				...
																				<table width="100%" border="0" cellspacing="0" cellpadding="0">
																					<tr>
																						<td class="pb-50" style="padding-bottom: 50px; margin-top: 50px;">
																							<table width="100%" border="0" cellspacing="0" cellpadding="0">
																								<tr>
																									<td class="img" height="0" bgcolor="#ebebeb" style="font-size:0pt; line-height:0pt; text-align:left;">&nbsp;</td>
																								</tr>
																							</table>
																						</td>
																					</tr>
