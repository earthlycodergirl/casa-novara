																			...
																			<td class="px-50 mpx-15" style="padding-left: 50px; padding-right: 50px;">
																							...
																							<table width="100%" border="0" cellspacing="0" cellpadding="0">
																								<tr>
																									<td class="fluid-img img-center pb-50" style="font-size:0pt; line-height:0pt; text-align:center; padding-bottom: 50px;">
																										<img src="https://kiinrealty.com/adm/uploads/'.$prop->Property->image.'" width="268" border="0" alt="" />
																									</td>
																								</tr>
																								<tr>
																				...
																				<table width="100%" border="0" style="border: 1px solid #eeeeee;" cellspacing="0" cellpadding="0">
																					...
																					<tr>
																						...
																						<td class="text-16 lh-26 a-center" style="font-size:16px; color:#333333; font-family:\'PT Sans\', Arial, sans-serif; line-height: 26px; text-align:left;"><a href="https://kiinrealty.com/listing/'.$prop->Property->property_id.'">View property</a></td>
																					</tr>
																					<tr>
																						<td class="img" height="1" bgcolor="#ebebeb" style="font-size:0pt; line-height:10pt; text-align:left;" colspan="2">&nbsp;</td>
																					</tr>
...
echo json_encode(array('errors'=>$errors,'success'=>$success));
	...
	?>
	<script>
	window.location.href="https://kiinrealty.com";
	</script>
	<?php
}
