...
$_POST['phone'] = '14802393987';
$_POST['notes'] = 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.';
$_POST['prop'] = 67;*/
...
if(isset($_POST['req']) && $_POST['req'] == 39){

		$prop = new Emails();
		$save_req = $prop->saveRequest($_POST);
		if($save_req['success'] == 1){

			$send_to = array();
			// get administrative emails to send to
			$getCon = new SqlIt("SELECT * FROM site_contact WHERE contact_section = ?","select",array('request_emails'));
			...
			if(isset($_POST['prop']) && $_POST['prop'] > 0){

				$prop->getProp($_POST['prop']);
...
<head>
	...
	<!--<![endif]-->
	<title>Property request received from website.</title>
	<!--[if gte mso 9]>
																		...
																		<tr>
																			<td class="px-50 mpx-15" style="padding-left: 50px; padding-right: 50px;">
																							...
																							<table width="100%" border="0" cellspacing="0" cellpadding="0">
																								<tr>
																									<td class="fluid-img img-center pb-50" style="font-size:0pt; line-height:0pt; text-align:center; padding-bottom: 50px;">
																										<img src="https://casanovaragroup.com/adm/uploads/'.$prop->Property->image.'" width="268" border="0" alt="" />
																									</td>
																								</tr>
																								<tr>
																								...
																								<tr>
																									<td class="title-22 a-center c-purple pb-15" style="font-size:18px; line-height:26px; font-family:\'PT Sans\', Arial, sans-serif; min-width:auto !important; text-align:center; color:#000; padding-bottom: 15px;">
																										'.$prop->Property->property_title.'
																									</td>
																								</tr>
																								<tr>
																									<td class="text-16 lh-26 a-center" style="font-size:16px; color:#6e6e6e; font-family:\'PT Sans\', Arial, sans-serif; min-width:auto !important; line-height: 26px; text-align:center;">
																										You have received a property request through your website. The client information is below. Please do not reply to this email directly. You can view the property by clicking the link below:
																									</td>
																								</tr>
																							</table>
																						</td>
																				...
																				<table width="100%" border="0" style="border: 1px solid #eeeeee;" cellspacing="0" cellpadding="0">
																					...
																					<tr>
																						<td class="text-16 lh-26 a-center" style="font-size:16px; color:#6e6e6e; font-family:\'PT Sans\', Arial, sans-serif; width: 140px; !important; line-height: 26px; text-align:center;">
																							Property
																						</td>
																						<td class="text-16 lh-26 a-center" style="font-size:16px; color:#333333; font-family:\'PT Sans\', Arial, sans-serif; line-height: 26px; text-align:left;"><a href="https://casanovaragroup.com/listing/'.$prop->Property->property_id.'">View property</a></td>
																					</tr>
																					<tr>
																						<td class="img" height="1" bgcolor="#ebebeb" style="font-size:0pt; line-height:10pt; text-align:left;" colspan="2">&nbsp;</td>
																					</tr>
																					...
																					<tr>
																						...
																						<td class="text-16 lh-26 a-center" style="font-size:16px; color:#333333; font-family:\'PT Sans\', Arial, sans-serif; line-height: 26px; text-align:left;">'.$prop->Request->name.'</td>
																					</tr>
																					...
																					<tr>
																						...
																						<td class="text-16 lh-26 a-center" style="font-size:16px; color:#333333; font-family:\'PT Sans\', Arial, sans-serif; line-height: 26px; text-align:left;">'.$prop->Request->email.'</td>
																					</tr>
																					...
																					<tr>
																						...
																						<td class="text-16 lh-26 a-center" style="font-size:16px; color:#333333; font-family:\'PT Sans\', Arial, sans-serif; line-height: 26px; text-align:left;">'.$prop->Request->phone.'</td>
																					</tr>
																					...
																					<tr>
																						<td class="text-16 lh-26 a-center" vertical-align="top" style="font-size:16px; color:#6e6e6e; font-family:\'PT Sans\', Arial, sans-serif; min-width: 140px !important; line-height: 26px; text-align:center;">
																							Client Notes
																						</td>
																						<td class="text-16 lh-26 a-center" style="font-size:14px; color:#333333; font-family:\'PT Sans\', Arial, sans-serif; line-height: 26px; text-align:left;">'.$prop->Request->notes.'</td>
																					</tr>
...
echo json_encode(array('errors'=>$errors,'success'=>$success));
	...
	echo json_encode($save_req);
}
}else{
	?>
	<script>
						window.location.href="https://casanovaragroup.com";
	</script>
	<?php
}
